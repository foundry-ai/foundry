# TODO: For now we have lifted the
# implicit diff from JaxOPT. This code has been hacked
# to add some extra features to carry the solver state. 
# This code should be removed and cleanly rewritten from scratch.
...
def root_vjp(optimality_fun: Callable,
  ...
  def fun_sol(sol):
    ...
    return optimality_fun((sol, aux), *args)
...
def _custom_root(solver_fun, optimality_fun, solve, has_aux,
  ...
  def make_custom_vjp_solver_fun(solver_fun, kwarg_keys):
    ...
    def solver_fun_bwd(tup, cotangent):
      ...
      vjps = root_vjp(optimality_fun=optimality_fun, sol=sol, aux=aux,
