from foundry.solver import Solver, Objective, SolverState, SolverResult
from foundry.core.dataclasses import dataclass, field, replace
from foundry.solver.util import implicit_diff_solve
...
class IterativeSolver(Solver):
    ...
    def _do_step(self, kwargs, objective : Objective,
        ...
        #foundry.util.assert_trees_all_equal_shapes_and_dtypes(solver_state, state)
        return state
