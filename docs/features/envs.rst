...
The :py:mod:`foundry.envs` module provides a standard way to define and manage jax-enabled environments.

.. currentmodule:: foundry.env
...
Similar to :py:mod:`foundry.datasets`, 
the :py:attr:`foundry.env.environments` provides an :py:class:`EnvironmentRegistry`
...
.. code-block:: python
    ...
    from foundry.env import environments
    ...
    import foundry.policy as policy
